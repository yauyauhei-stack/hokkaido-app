...
# ==========================================
top_notice = {
    "zh": "📢 現正報名：現在加入行程每位減 HKD$50！一齊出發去北海道啦！📢發哥旅行社 ✈️正式營運！最早出發的旅行團將於7月16日出發✈️",
    "en": "📢 Special Offer: Join now and save HKD$50 per person! Let's go to Hokkaido!📢Fatgo Travel Agency ✈️ Officially operational!✈️The earliest tour will depart on July 16✈️",
    "jp": "📢 絶賛受付中：今ならお一人様50香港ドル割引！一緒に北海道へ行こう！📢ファットゴー旅行代理店✈️正式に営業開始！✈️最も早いツアーは7月16日に出発します。✈️"
}
# ==========================================
