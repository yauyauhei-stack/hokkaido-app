...
# ==========================================
top_notice = {
    "zh": "📢 現正報名：現在加入行程每位減 HKD$50！一齊出發去北海道啦！📢✈️發哥旅行社 ✈️正式營運！📢✈️最早出發的旅行團將於7月16日出發✈️📢最新消息 : 航空公司日前宣布，7月1日起下調燃油附加費。詳情請參閱有關航空公司。",
    "en": "📢 Special Offer: Join now and save HKD$50 per person! Let's go to Hokkaido!📢Fatgo Travel Agency ✈️ Officially operational!📢✈️The earliest tour will depart on July 16✈️📢Update: The airline recently announced that it will reduce its fuel surcharge from July 1. See About Airline for more information.",
    "jp": "📢 絶賛受付中：今ならお一人様50香港ドル割引！一緒に北海道へ行こう！📢ファットゴー旅行代理店✈️正式に営業開始！📢✈️最も早いツアーは7月16日に出発します。✈️📢最新情報：同航空会社は先日、7月1日から燃油サーチャージを引き下げると発表しました。詳細は「航空会社について」をご覧ください。"}
# ==========================================
...
itinerary = [
    {
        ...
        "note3": m("晚上前往燒肉店品嚐極上成吉思汗羊肉 🥩 | 入住旭川：經濟酒店 烏帕希 (Hotel WBF Asahikawa) 。",
                   "Evening: Enjoy premium mutton at a Genghis Khan  🥩 | Check-in at Hotel WBF Asahikawa.",
                   "夜は焼肉店で極上チンギス・ハンの羊肉 🥩 |旭川：エコノミーホテルウパヒ。")
    },
    {
        "title": "DAY 2 🌸", 
